...
public class ArticleController extends Controller {
	...
	public void doArticleWrite() {
		...
		articles.add(new Article(lastArticleNumber, title, body, date, loginedMember.id));
	...
	public void doArticleSearch() {
		...
		for (Article a : articles) {
			if (a.title.contains(searchKey)) {
				...
				System.out.println(a.number + "번 게시글 " + "( 내용 : " + a.body + " )" + " ( 조회수 : " + a.hit + " ) ");
			} else if (a.writeId.contains(searchKey)) {
				System.out.println(a.number + "번 게시글 " + "( 내용 : " + a.body + " )" + " ( 조회수 : " + a.hit + " ) ");
			} else
				count++;
	...
	public void showArticleDetail() {
		...
		System.out.println("작성자 : " + articles.get(articleIndex).writeId);
	...
	public void doArticleModify() {
		...
		if (!(articles.get(articleIndex).writeId.equals(loginedMember.id))) {
